...
function chartivio_render_how_to_use_page()
{
    ...
    <div class="wrap chartivio-how-to-use">
        ...
        <div class="chartivio-guide-container">
            <!-- Introduction -->
            <div class="chartivio-guide-section chartivio-intro">
            ...
            <div class="chartivio-guide-grid">
                ...
                <!-- Step 2: Select Type -->
                <div class="chartivio-guide-card">
                    <div class="chartivio-step-icon">2</div>
                ...
                <!-- Step 3: Data Source -->
                <div class="chartivio-guide-card">
                    <div class="chartivio-step-icon">3</div>
                    <h3>Add Your Data</h3>
                ...
                <!-- Step 4: Shortcode -->
                <div class="chartivio-guide-card">
                    <div class="chartivio-step-icon">4</div>
                    <h3>Publish & Embed</h3>
