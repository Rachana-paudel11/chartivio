...
function dearcharts_render_main_box($post)
{
    ...
    <div class="dc-admin-wrapper">
        <div class="dc-main-header" style="justify-content: space-between;">
            <div style="display:flex; align-items:center; gap:20px;">
                <div class="dc-logo">
                    <img src="<?php echo esc_url(DEARCHARTS_URL . 'assets/images/logo.png'); ?>" alt="DearCharts Logo"
                        style="height: 40px; width: auto; display: block;">
                </div>
                <div
                    style="display:flex; align-items:center; gap:10px; border-left: 1px solid #e2e8f0; padding-left: 20px;">
                    <span
                        style="font-weight: 700; color: #1e293b; font-size: 14px; text-transform: uppercase; letter-spacing: 0.05em;">Chart
                        Type</span>
                ...
                </div> <!-- closes chart type selector group -->
            </div> <!-- closes logo + selector group -->
