...
function dearcharts_render_main_box($post)
{
    ...
    <style>
        ...
        /* Specific rules for CSV preview container to respect max-height */
        #dc-csv-preview-container {
            height: auto !important;
            max-height: 250px !important;
            /* Will be overridden by JS when expanded */
            flex: 0 0 auto !important;
            /* Don't grow, respect max-height */
        }
