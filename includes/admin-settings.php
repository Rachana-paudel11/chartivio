...
function dearcharts_render_tabbed_meta_box($post)
{
    ...
    <style>
        ...
        /* Modern thin grey scrollbar */
        .dc-table-scroll-container::-webkit-scrollbar {
            height: 6px;
        }

        .dc-table-scroll-container::-webkit-scrollbar-track {
            background: #f1f5f9;
            border-radius: 10px;
        }

        .dc-table-scroll-container::-webkit-scrollbar-thumb {
            background: #cbd5e1;
            border-radius: 10px;
        }

        .dc-table-scroll-container::-webkit-scrollbar-thumb:hover {
            background: #94a3b8;
        }
        ...
        .dearcharts-table th:last-child,
        .dearcharts-table td:last-child {
            min-width: 50px;
            text-align: center;
        }
        ...
        <div class="dearcharts-settings">
            ...
            <div id="tab-create-chart" class="dearcharts-tab-content active">
                ...
                <div id="panel-manual" class="dearcharts-card"
                    ...
                    <div class="dearcharts-card-body">
                        <div class="dc-table-scroll-container">
